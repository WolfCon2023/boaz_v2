    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-4">
        <div className="w-full max-w-md rounded-2xl border border-[color:var(--color-border)] bg-[color:var(--color-panel)] p-6 shadow-xl">
          <div className="mb-4 max-w-sm mx-auto text-center space-y-1">
            <div className="text-xs font-semibold text-[color:var(--color-primary)] whitespace-nowrap">BOAZ says</div>
            <h1 className="text-base font-semibold whitespace-nowrap">
              Enter your signing username &amp; security code
            </h1>
            <p className="mt-1 text-xs text-[color:var(--color-text-muted)] max-w-sm mx-auto leading-relaxed">
