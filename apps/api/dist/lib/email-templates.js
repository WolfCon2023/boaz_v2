 ...
 */
export function formatEmailTimestamp(date) {
 ...
 */
export function createField(label, value) {
    return `
...
export function createStandardEmailTemplate(options) {
...
export function createStandardTextEmail(options) {
    const year = new Date().getFullYear();
    const parts = [];
    parts.push('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
