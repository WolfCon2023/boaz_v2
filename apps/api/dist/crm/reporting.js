...
reportingRouter.get('/overview', async (req, res) => {
    ...
    const deals = (await db.collection('deals').find(closeDateMatch).project({ title: 1, amount: 1, stage: 1, ownerId: 1, forecastedCloseDate: 1, closeDate: 1, dealNumber: 1, lastActivityAt: 1, updatedAt: 1, createdAt: 1, stageChangedAt: 1 }).toArray());
